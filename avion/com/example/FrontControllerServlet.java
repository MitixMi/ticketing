...
import avion.com.controller.DatabaseConnection;
import avion.com.controller.Mapping;
...
public class FrontControllerServlet extends HttpServlet {
    ...
    private void saveFileToDatabase(byte[] fileBytes) {
        ...
        try (Connection connection = DatabaseConnection.getConnection(); PreparedStatement statement = connection.prepareStatement(insertSQL)) {
